# Statistical Inference - Week 1 - Quiz 1
...
![](https://github.com/aakhacha/Coursera_Data_Science_Johns_Hopkins/blob/master/Course_6_Statistical_Inference/Week_1/plot1.png)
</br>
...
intersection: (denoted by n) intersection A n B of two sets A and B is the set that contains all elements of A that also belong to B (or equivalently, all elements of B that also belong to A), but no other elements
<br>
A = Mother
<br>
B = Father
...
P(AnB) = 6%
<br>
Since we know P(A?B)=P(A)+P(B)-P(AnB) we get
<br>
17%=P(A)+12%-6%.
<br>
P(A) = 11%
...
Explanation: </br>
![](https://github.com/aakhacha/Coursera_Data_Science_Johns_Hopkins/blob/master/Course_6_Statistical_Inference/Week_1/plot2.png)