...
Give a P-value for the two sided hypothesis test of whether ﬂ1 from a linear regression model is 0 or not.
...
<img src="https://github.com/aakhacha/Coursera_Data_Science_Johns_Hopkins/blob/master/Course_7_Regression_Models/Week_2/plot1.png" alt="Residual Standard Deviation Formula">
...
<img src="https://github.com/aakhacha/Coursera_Data_Science_Johns_Hopkins/blob/master/Course_7_Regression_Models/Week_2/plot2.png" alt="Confidence Interval Formuala">
...
Question 4
----------
Refer to the previous question. Read the help file for ????????????. What is the weight coefficient interpreted as?
...
<img src="https://github.com/aakhacha/Coursera_Data_Science_Johns_Hopkins/blob/master/Course_7_Regression_Models/Week_2/plot3.png" alt="Prediction Interval Formula">
...
Question 6
----------
Consider again the ???????????? data set and a linear regression model with mpg as predicted by weight (in 1,000 lbs). A ìshortî ton is defined as 2,000 lbs. Construct a 95% confidence interval for the expected change in mpg per 1 short ton increase in weight. Give the lower endpoint.
...
Question 8
----------
I have an outcome, Y, and a predictor, X and fit a linear regression model with Y=ﬂ0+ﬂ1X+? to obtain ﬂ^0 and ﬂ^1. What would be the consequence to the subsequent slope and intercept if I were to refit the model with a new regressor, X+c for some constant, c?

<img src="https://github.com/aakhacha/Coursera_Data_Science_Johns_Hopkins/blob/master/Course_7_Regression_Models/Week_2/plot4.png" alt="New Intercept">

* The new slope would be ﬂ^1+c

* The new intercept would be ﬂ^0-cﬂ^1

* The new intercept would be ﬂ^0+cﬂ^1

* The new slope would be cﬂ^1
...
<img src="https://github.com/aakhacha/Coursera_Data_Science_Johns_Hopkins/blob/master/Course_7_Regression_Models/Week_2/plot5.png" alt="Sum of Squared Errors"> </br> 
